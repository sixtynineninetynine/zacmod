...
public class Config {
        ...
        private static final ForgeConfigSpec.BooleanValue ZOMBIES_BREAK_BLOCKS = BUILDER
                        .comment("Whether zombies can break blocks or not")
                        .define("zombiesBreakBlocks", true);

        private static final ForgeConfigSpec.IntValue ZOMBIE_BLOCK_BREAK_REACH = BUILDER
                        .comment("Block breaking reach of zombies")
                        .defineInRange("zombieBlockBreakReach", 3, 1, 25);

        private static final ForgeConfigSpec.IntValue BLOCK_MINIMUM_HARDNESS = BUILDER
                        .comment("Minimum hardness of blocks that should be broken")
                        .defineInRange("blockMinimumHardness", 0, -1, 50);

        private static final ForgeConfigSpec.IntValue BLOCK_MAXIMUM_HARDNESS = BUILDER
